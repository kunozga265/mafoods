            ...
            <div class="block">
                <div class="container auth-card">
                    <div class="title-style2 center-align">
                        <h4 itemprop="headline"><i>Account</i> Registration</h4>
                    </div>
                    <form @submit.prevent="submit"  class="form">
                            <div class="row">
                                <div class="col-sm-12">
                                    <label for="user_name">Name</label>
                                    <input v-model="form.name" id="user_name" type="text" required>
                                    <div class="error-message" v-if="form.errors.name">{{form.errors.name }}</div>
                                </div>
                                <div class="col-sm-12">
                                    <label for="user_email">Email</label>
                                    <input v-model="form.email" id="user_email" type="email" required>
                                    <div class="error-message" v-if="form.errors.email">{{form.errors.email }}</div>
                                </div>
                                <div class="col-sm-12">
                                    <label for="user_password">Password</label>
                                    <input v-model="form.password" id="user_password" type="password" required>
                                    <div class="error-message" v-if="form.errors.password">{{form.errors.password }}</div>
                                </div>
                                <div class="col-sm-12">
                                    <label for="user_password_confirmation">Password Confirmation</label>
                                    <input v-model="form.password_confirmation" id="user_password_confirmation" type="password" required>
                            ...
                            <div class="action">
                                ...
                                <div class="mt-8">Already have an account?
